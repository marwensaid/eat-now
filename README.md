...
Objectif général
Vous devez concevoir, développer et déployer une application simplifiée de restauration composée de 3 microservices Spring Boot.
...
Développer les 3 microservices,


Les dockeriser et les déployer sur Kubernetes (avec Helm ou manifests YAML),


Mettre en place le monitoring,


Réaliser un schéma d’architecture global (Draw.io),


Préparer un README clair pour le déploiement et le test.
...
- Lister tous les plats- Consulter le détail d’un plat- Ajouter un plat- Modifier ou supprimer un plat
order-service
Gestion des commandes clients
- Créer une commande (références plats)- Consulter une commande- Lister les commandes d’un utilisateur- Mettre à jour le statut (CREATED → DELIVERED)
delivery-service
Gestion des livraisons
- Créer une livraison associée à une commande- Assigner un livreur- Modifier le statut de livraison- Consulter la livraison
...
3 dossiers de microservices : menu-service, order-service, delivery-service


Un Dockerfile par service


Les manifests Kubernetes (ou un chart Helm)


Le fichier d’architecture Draw.io
