# �️ Eat Now - Application de Restauration

Application de commande de repas en ligne basée sur une architecture microservices.

**Technologies :** Java 17 • Spring Boot 3 • Kubernetes • Grafana • Prometheus • Resilience4j

---

## ✅ État du projet

### Services développés et opérationnels

| Service              | Port | Statut          | Description                    |
| -------------------- | ---- | --------------- | ------------------------------ |
| **menu_service**     | 8081 | ✅ Opérationnel | Gestion du catalogue des plats |
| **order_service**    | 8082 | ✅ Opérationnel | Gestion des commandes clients  |
| **delivery_service** | 8083 | ✅ Opérationnel | Gestion des livraisons         |

### Fonctionnalités implémentées

- ✅ **Communication inter-services** avec WebClient (réactif)
- ✅ **Résilience** avec Resilience4j (Circuit Breaker, Retry, Time Limiter)
- ✅ **Documentation API** avec Swagger/OpenAPI 3
- ✅ **Métriques** avec Spring Actuator et Micrometer Prometheus
- ✅ **Validation** des données avec Jakarta Bean Validation
- ✅ **Gestion d'erreurs** centralisée avec GlobalExceptionHandler
...
```bash
curl http://localhost:8081/api/dishes/health  # Menu Service
curl http://localhost:8082/api/orders/health  # Order Service
curl http://localhost:8083/api/deliveries/health  # Delivery Service
```
...
- **Menu Service** : http://localhost:8081/swagger-ui/index.html
- **Order Service** : http://localhost:8082/swagger-ui/index.html
- **Delivery Service** : http://localhost:8083/swagger-ui/index.html

### README détaillés

- [menu_service/README.md](./menu_service/README.md) - Documentation complète du service de menu
- [order_service/README.md](./order_service/README.md) - Documentation complète du service de commande
- [delivery_service/README.md](./delivery_service/README.md) - Documentation complète du service de livraison
...
Vous avez 4 heures pour : 1. Développer les 3 microservices, 2. Les dockeriser et les déployer sur Kubernetes (avec Helm ou manifests YAML), 3. Mettre en place le monitoring, 4. Réaliser un schéma d’architecture global (Draw.io), 5. Préparer un README clair pour le déploiement et le test.
...
À la fin des 4 heures, vous devez avoir : 1. 3 dossiers de microservices : menu-service, order-service, delivery-service 2. Un Dockerfile par service 3. Les manifests Kubernetes (ou un chart Helm) 4. Le fichier d’architecture Draw.io 5. Le README.md avec :
